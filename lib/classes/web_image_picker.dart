...
import 'package:intmpc/classes/src_web_image_picker.dart';
...
class FlutterWebImagePicker {
  ...
  static Future<List> get getImage async {
    final data =
    ...
    return [Image.memory(imageData, semanticLabel: imageName),data['data']];
  }
}
